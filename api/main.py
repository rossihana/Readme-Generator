...
def build_llm_prompt(repo_data: dict) -> list:
    ...
    system_prompt = (
        "Anda adalah ahli dokumentasi perangkat lunak. "
        "Tugas Anda adalah menghasilkan file README.md yang lengkap, jelas, dan profesional "
        "berdasarkan informasi yang tersedia dari repository GitHub yang diberikan.\n\n"
        "README harus ditulis dalam format Markdown dan mencakup bagian berikut secara berurutan:\n"
        "1. Deskripsi Proyek\n"
        "2. Fitur Utama\n"
        ...
        "7. Kontribusi\n\n"
        "Gunakan bahasa yang informatif, ringkas, dan mudah dipahami oleh pengembang. "
        "Sertakan emoji yang relevan secukupnya untuk meningkatkan keterbacaan.\n\n"
        "Gunakan HANYA informasi yang tersedia dari struktur direktori dan file konfigurasi. "
        "Jika informasi tertentu tidak tersedia, tuliskan bahwa bagian tersebut belum disediakan "
        "tanpa membuat asumsi atau menambahkan informasi yang tidak ada.\n\n"
        "Pastikan bagian Instalasi dan Penggunaan ditulis secara jelas dan konsisten "
        "dengan konfigurasi proyek yang tersedia."
    )
